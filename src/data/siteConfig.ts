...
export const ui = {
    ...
    achievements_header: { en: "03_ACHIEVEMENTS_&_AWARDS", pl: "03_OSIĄGNIĘCIA_I_NAGRODY" },
    // NOWOŚĆ: Nagłówek Usług
    services_header: { en: "04_AVAILABLE_SERVICES", pl: "04_DOSTĘPNE_USŁUGI" },
    // Przesuwamy numerację Kontaktu
    contact_header: { en: "05_COMMUNICATION_UPLINK", pl: "05_KANAŁ_KOMUNIKACJI" },
...
// --- SERVICES DATA ---
// To są "bezpieczne" usługi, w których czujesz się mocny
...
// --- SVG ICONS (Bez zmian, tylko dodajemy service_box jeśli potrzebny) ---
export const icons = {
